...
in
    getResponse2,
        ...
        expand2 = Table.ExpandRecordColumn(expand1, "leads", {"requestid",	"sent",	"referer",	"utm_medium",	"utm_source",	"utm_campaign",	"utm_term",	"utm_content",	"Form name",	"Formname",	"time",	"comment",	"data",	"category",	"INN",	"question",	"type",	"Причина отказа"}, {"requestid",	"sent",	"referer",	"utm_medium",	"utm_source",	"utm_campaign",	"utm_term",	"utm_content",	"Form name",	"Formname",	"time",	"comment",	"data",	"category",	"INN",	"question",	"type",	"Причина отказа"}),
